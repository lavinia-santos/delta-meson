...
def do_eos_delta():
    ...
    for i in range(0, num_lines):
       with open(temp_input_file, "w") as tempfile:
        ...
        result = subprocess.run("./beta-eq-eos20", shell=True)
            #result
...
def do_tov_delta():
    ...
    for i in range(0, num_lines):
        ...
        result = subprocess.run("./tov2", shell=True)
        result
...
def do_properties_delta():
    ...
    for i in range(0, num_lines):
       with open(temp_input_file, "w") as tempfile:
        ...
        # Execute the external command
        # result = subprocess.run("./properties_eos20", shell=True)
        result = subprocess.run("./esym_eos2", shell=True)
