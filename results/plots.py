...
for label in labels:
        ...
        plt.plot(xi, yi, color=colors[label%4])
        #plt.plot(xi,yi)
...
#     plt.plot(q1, mass, color=colors[i%3] , linestyle='dashed')
#     q3=df['q3'].to_numpy()
#     #print(len(q3))
#     plt.plot(q3, mass, color=colors[i%3], linestyle='dashed')
...
# # plt.ylabel('Mass')
# #plt.title(f"EOS{num}")
# #plt.savefig(f"all-with-without-delta.png")
# plt.show()